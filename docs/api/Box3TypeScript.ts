...
declare class Box3Animation<KeyframeType, TargetType> {
  ...
  then<T>(
    resolve: (event: Box3AnimationEvent<KeyframeType, TargetType>) => T,
...
declare class Box3World {
   ...
   */
  addCollisionFilter: (
    aSelector: Box3SelectorString,
    bSelector: Box3SelectorString
  ) => void;
  /**
  ...
  raycast: (
    ...
    options?: Partial<Box3RaycastOptions>
  ) => Box3RaycastResult;
  /**
   ...
   */
  animate: (
    keyframes: Partial<Box3WorldKeyframe>[],
    playbackInfo?: Partial<Box3AnimationPlaybackConfig>
  ) => Box3Animation<Box3WorldKeyframe, Box3World>;
...
declare class Box3Entity implements Box3EntityConfig {
   ...
   */
  animate: (
    keyframes: Partial<Box3EntityKeyframe>[],
    playbackInfo?: Partial<Box3AnimationPlaybackConfig>
  ) => Box3Animation<Box3EntityKeyframe, Box3Entity>;
...
declare type Box3DialogCall =
  | ((
      params: Box3TextDialogParams
    ) => Promise<string | null> & Box3DialogCancelOption)
  | ((
      params: Box3SelectDialogParams
    ) => Promise<Box3DialogSelectResponse | null> & Box3DialogCancelOption)
  | ((
      params: Box3InputDialogParams
    ) => Promise<string | null> & Box3DialogCancelOption);
...
declare class Box3Player {
   ...
   */
  animate: (
    keyframes: Partial<Box3PlayerKeyframe>[],
    playbackConfig?: Box3AnimationPlaybackConfig
  ) => Box3Animation<Box3PlayerKeyframe, Box3Player>;
 ...
 * @category events
 */
declare type Box3EventChannel<EventType> = (
 ...
 * @category events
 */
declare type Box3EventFuture<EventType> = (
...
declare type Box3HttpHandler = (
  request: Box3HttpRequest,
  response: Box3HttpResponse
) => void;
declare class Box3HttpAPI {
  url: string;
  fetch: (
    url: string,
    params?: Box3HttpFetchParams
  ) => Promise<Box3HttpFetchResponse>;
